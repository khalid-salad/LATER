...
int main(int argc, char *argv[]) {
  ...
  // printf("debug 1\n");
  cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, m, n, n, &sone, B, m, A, n,
              &szero, work, m);
  ...
  if (checkFlag) {
    ...
    cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_N, m, n, m, &sone, dB, m, A, n,
                &szero, work, m);
    ...
    cublasSgemm(handle, CUBLAS_OP_N, CUBLAS_OP_T, m, n, n, &snegone, B, m, A, n,
                &sone, dB, m);
...

  {
    ...
    cublasStrsm(handle, CUBLAS_SIDE_LEFT, CUBLAS_FILL_MODE_LOWER, CUBLAS_OP_N,
                CUBLAS_DIAG_NON_UNIT, m, n, &sone, A, m, B, m);
