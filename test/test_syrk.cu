...
int main(int argc, char *argv[]) {
  ...
  cublasSsyrk(handle, CUBLAS_FILL_MODE_LOWER, CUBLAS_OP_N, n, k, &sone, A, n,
              &szero, C, n);
  ...
  if (checkFlag) {
    ...
    cublasSgeam(handle, CUBLAS_OP_N, CUBLAS_OP_N, n, n, &sone, C, n, &snegone,
                tC, n, C, n);
  ...
  cublasGemmEx(handle, CUBLAS_OP_N, CUBLAS_OP_T, n, n, k, &sone, Ah, CUDA_R_16F,
               n, Ah, CUDA_R_16F, n, &szero, C, CUDA_R_32F, n, CUDA_R_32F,
