...
void later_qdwh_polar(cudaCtxt ctxt, int n, float *A, int lda, float *H,
                      int ldh, float *tmpA, float *work, __half *hwork);
...
/*
copy_upper_to_lower: copies the lower triangle to upper triangle for square
matrix on GPU
 */
...
void slowGenerateUniformPositiveDefiniteMatrix(float *dA, int n);

__global__ void generateUniformPositiveDefiniteMatrix(float *dA, int n);
...
// utilities
__global__ void deviceCopy(int m, int n, float *da, int lda, float *db,
                           int ldb);
void sSubstract(cublasHandle_t handle, int m, int n, float *dA, int lda,
                float *dB, int ldb);
__global__ void clearTri(char uplo, int m, int n, float *a, int lda);

__global__ void sSubstractAndSquare(int m, int n, float *dA, int lda, float *dB,
                                    int ldb);
